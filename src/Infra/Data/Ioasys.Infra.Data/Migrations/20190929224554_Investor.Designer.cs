...
namespace Ioasys.Infra.Data.Migrations
{
    ...
    [Migration("20190929224554_Investor")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ioasys.Domain.Entities.Investor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("Inv_Investor");
                });

            modelBuilder.Entity("Ioasys.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Ioasys.Domain.Entities.User", b =>
                {
                    b.HasOne("Ioasys.Domain.Entities.Enterprise.Enterprise", "Enterprise")
                        .WithMany("Users")
                        .HasForeignKey("EnterpriseId");

                    b.HasOne("Ioasys.Domain.Entities.Investor", "Investor")
                        .WithMany("Users")
